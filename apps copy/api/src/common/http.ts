...
export class ApiUnauthorized extends UnauthorizedException {
  constructor(code = "UNAUTHENTICATED", message = "Authentication required") {
    super({ error: { code, message } });
  }
}
export class ApiForbidden extends ForbiddenException {
  constructor(
    code = "FORBIDDEN",
...
export class ApiNotFound extends NotFoundException {
